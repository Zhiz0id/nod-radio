package ru.rusnod.radio.helpers;
...
public class LiveStreamServer extends HttpServer {
    ...
    public static final String REDIRECT_URL = addressForUrl(REDIRECT_RESOURCE);
    public static final String DIRECT_URL = addressForUrl(DIRECT_RESOURCE);
